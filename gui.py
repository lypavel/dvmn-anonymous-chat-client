...
def create_status_panel(root_frame):
    ...
    nickname_label = tk.Label(connections_frame,
                              height=1,
                              fg='grey',
                              font='arial 10',
                              anchor='w')
    ...
    status_read_label = tk.Label(connections_frame,
                                 height=1,
                                 fg='grey',
                                 font='arial 10',
                                 anchor='w')
    ...
    status_write_label = tk.Label(connections_frame,
                                  height=1,
                                  fg='grey',
                                  font='arial 10',
                                  anchor='w')
...
async def draw(messages_queue, sending_queue, status_updates_queue):
    ...
    async with create_task_group() as task_group:
        ...
        task_group.start_soon(update_conversation_history,
                              conversation_panel,
                              messages_queue)
        task_group.start_soon(update_status_panel,
                              status_labels,
